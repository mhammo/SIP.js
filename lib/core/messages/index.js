...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../grammar", "./methods", "./body", "./digest-authentication", "./incoming-message", "./incoming-request-message", "./incoming-request", "./incoming-response-message", "./incoming-response", "./outgoing-request-message", "./outgoing-request", "./outgoing-response", "./parser"], factory);
    }
