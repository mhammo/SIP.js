(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../messages", "../session", "../timers", "../transactions", "../user-agents/bye-user-agent-client", "../user-agents/bye-user-agent-server", "../user-agents/info-user-agent-client", "../user-agents/info-user-agent-server", "../user-agents/message-user-agent-client", "../user-agents/message-user-agent-server", "../user-agents/notify-user-agent-client", "../user-agents/notify-user-agent-server", "../user-agents/prack-user-agent-client", "../user-agents/prack-user-agent-server", "../user-agents/re-invite-user-agent-client", "../user-agents/re-invite-user-agent-server", "../user-agents/refer-user-agent-client", "../user-agents/refer-user-agent-server", "./dialog"], factory);
    }
