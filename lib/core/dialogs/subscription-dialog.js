(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../messages", "../subscription", "../timers", "../user-agent-core/allowed-methods", "../user-agents/notify-user-agent-server", "../user-agents/re-subscribe-user-agent-client", "./dialog"], factory);
    }
