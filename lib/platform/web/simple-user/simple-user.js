(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../../api", "../modifiers", "../session-description-handler", "../transport"], factory);
    }
    ...
    class SimpleUser {
        ...
        get localMediaStream() {
            ...
            if (!(sdh instanceof session_description_handler_1.SessionDescriptionHandler)) {
        ...
        setHold(hold) {
            ...
            session.sessionDescriptionHandlerModifiersReInvite = hold ? [modifiers_1.holdModifier] : [];
            // Send re-INVITE
            return this.session
                .invite(options)
                .then(() => {
