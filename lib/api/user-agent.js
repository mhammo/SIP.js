(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../core", "../core/messages/utils", "../platform/web/session-description-handler", "../platform/web/transport", "../version", "./emitter", "./invitation", "./inviter", "./message", "./notification", "./user-agent-options", "./user-agent-state"], factory);
    }
